...
class Program
{
    static void Main()
    {
        DoublyLinkedList list = new DoublyLinkedList(); // initialise the doubly linked list as a new obj
        list.CreateList(); // run the method to create/populate the new list 
        
        Console.WriteLine("Elements in the list:"); // then display list
        list.DisplayList();
    }
}